...
public class BadLemming extends Character {
    ...
    public BadLemming(Animation up, Animation down, Animation left, Animation right,
    ...
    public BadLemming(String pathName, int [] duration, float x, float y, float colxOffset, float colyOffset, float colWidth, float colHeight, CharacterStats stats) throws SlickException {
